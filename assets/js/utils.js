(function () {
	...
	function oa(a, b) {
		for (var c = fa(a.h()), d = 0; d < c.length; d++) {
			...
			if (null != b.a[e]) {
				...
				var g = 11 == f.a || 10 == f.a;
				if (f.g)
					for (var f = t(b, e) || [], h = 0; h < f.length; h++) {
						var l = a,
							n = e,
							u = g ? f[h].clone() : f[h];
						l.a[n] || (l.a[n] = []);
	...
	function x(a, b) {
		var c;
		if (null != a.a[b]) c = w(a, b, void 0);
		else a: {
			c = a.f[b];
			if (void 0 === c.b) {
				var d = c.j;
				if (d === Boolean) c.b = !1;
				else if (d === Number) c.b = 0;
				else if (d === String) c.b = c.i ? "0" : "";
				else {
					c = new d;
					break a
				}
	...
	*/
	var L = {
		...
		qa = {
			...
			AR: [, [, , "1[1-5]\\d{8}|[2368]\\d{9}|9\\d{10}", "\\d{6,11}"],
				[, , "1[1-5]\\d{8}|(?:2(?:2(?:[013]\\d|2[13-79]|4[1-6]|5[2457]|6[124-8]|7[1-4]|8[13-6]|9[1267])|3(?:1[467]|2[03-6]|3[13-8]|[49][2-6]|5[2-8]|[067]\\d)|4(?:7[3-8]|9\\d)|6(?:[01346]\\d|2[24-6]|5[15-8])|80\\d|9(?:[0124789]\\d|3[1-6]|5[234]|6[2-46]))|3(?:3(?:2[79]|6\\d|8[2578])|4(?:[78]\\d|0[0124-9]|[1-35]\\d|4[24-7]|6[02-9]|9[123678])|5(?:[138]\\d|2[1245]|4[1-9]|6[2-4]|7[1-6])|6[24]\\d|7(?:[0469]\\d|1[1568]|2[013-9]|3[145]|5[14-8]|7[2-57]|8[0-24-9])|8(?:[013578]\\d|2[15-7]|4[13-6]|6[1-357-9]|9[124]))|670\\d)\\d{6}",
					"\\d{6,10}", , , "1123456789"
				],
				...
				"9$1", , , [
					...
					[, "(\\d{3})(\\d{3})(\\d{4})", "$1 $2-$3", ["2(?:2[013]|3[067]|49|6[01346]|80|9[147-9])|3(?:36|4[1-358]|5[138]|6[24]|7[069]|8[013578])", "2(?:2(?:0[013-9]|[13])|3(?:0[013-9]|[67])|49|6(?:[0136]|4[0-59])|8|9(?:[19]|44|7[013-9]|8[14]))|3(?:36|4(?:[12]|[358]4)|5(?:1|3[0-24-689]|8[46])|6|7[069]|8(?:[01]|34|[578][45]))"], "0$1", "", 1],
			...
			BR: [, [, , "[1-46-9]\\d{7,10}|5\\d{8,11}", "\\d{8,11}"],
				[, , "1[1-9][2-5]\\d{7}|(?:[4689][1-9]|2[12478]|3[1-578]|5[1-5]|7[13-579])[2-5]\\d{7}", "\\d{8,11}", , , "1123456789"],
					"\\d{7}(?:\\d{3})?", , , "2015555555"
				],
				[, , "8(?:00|44|55|66|77|88)[2-9]\\d{6}", "\\d{10}", , , "8002345678"],
				[, , "900[2-9]\\d{6}", "\\d{10}", , , "9002345678"],
			...
			ZW: [, [, , "2(?:[012457-9]\\d{3,8}|6\\d{3,6})|[13-79]\\d{4,8}|8[06]\\d{8}", "\\d{3,10}"],
				...
				[, , "86(?:1[12]|30|55|77|8[367]|99)\\d{6}", "\\d{10}", , , "8686123456"], "ZW", 263, "00", "0", , , "0", , , , [
					...
					[, "([2356]\\d{2})(\\d{3,5})", "$1 $2", ["2(?:[278]|0[45]|[49]8)|3(?:08|17|3[78]|[78])|5[15][78]|6(?:[29]8|37|[68][78])"], "0$1", "", 0],
	...
	*/
	...
	var N = {
		...
		sa = RegExp("[+\uff0b]+"),
		O = RegExp("^[+\uff0b]+"),
		ta = RegExp("([0-9\uff10-\uff19\u0660-\u0669\u06f0-\u06f9])"),
		ua = RegExp("[+\uff0b0-9\uff10-\uff19\u0660-\u0669\u06f0-\u06f9]"),
		va = /[\\\/] *x/,
		wa = RegExp("[^0-9\uff10-\uff19\u0660-\u0669\u06f0-\u06f9A-Za-z#]+$"),
		xa = /(?:.*?[A-Za-z]){3}.*/,
		ya = RegExp("(?:;ext=([0-9\uff10-\uff19\u0660-\u0669\u06f0-\u06f9]{1,7})|[ \u00a0\\t,]*(?:e?xt(?:ensi(?:o\u0301?|\u00f3))?n?|\uff45?\uff58\uff54\uff4e?|[,x\uff58#\uff03~\uff5e]|int|anexo|\uff49\uff4e\uff54)[:\\.\uff0e]?[ \u00a0\\t,-]*([0-9\uff10-\uff19\u0660-\u0669\u06f0-\u06f9]{1,7})#?|[- ]+([0-9\uff10-\uff19\u0660-\u0669\u06f0-\u06f9]{1,5})#)$",
			"i"),
		za = RegExp("^[0-9\uff10-\uff19\u0660-\u0669\u06f0-\u06f9]{2}$|^[+\uff0b]*(?:[-x\u2010-\u2015\u2212\u30fc\uff0d-\uff0f \u00a0\u00ad\u200b\u2060\u3000()\uff08\uff09\uff3b\uff3d.\\[\\]/~\u2053\u223c\uff5e*]*[0-9\uff10-\uff19\u0660-\u0669\u06f0-\u06f9]){3,}[-x\u2010-\u2015\u2212\u30fc\uff0d-\uff0f \u00a0\u00ad\u200b\u2060\u3000()\uff08\uff09\uff3b\uff3d.\\[\\]/~\u2053\u223c\uff5e*A-Za-z0-9\uff10-\uff19\u0660-\u0669\u06f0-\u06f9]*(?:;ext=([0-9\uff10-\uff19\u0660-\u0669\u06f0-\u06f9]{1,7})|[ \u00a0\\t,]*(?:e?xt(?:ensi(?:o\u0301?|\u00f3))?n?|\uff45?\uff58\uff54\uff4e?|[,x\uff58#\uff03~\uff5e]|int|anexo|\uff49\uff4e\uff54)[:\\.\uff0e]?[ \u00a0\\t,-]*([0-9\uff10-\uff19\u0660-\u0669\u06f0-\u06f9]{1,7})#?|[- ]+([0-9\uff10-\uff19\u0660-\u0669\u06f0-\u06f9]{1,5})#)?$",
			"i"),
		Aa = /(\$\d)/,
		Ba = /^\(?\$1\)?$/;
	...
	function Ga(a, b, c) {
		...
		a: {
			...
			for (var e, g = a.length, h = 0; h < g; ++h) {
				e = a[h];
				var l = y(e, 3);
				if (0 == l || 0 == f.search(w(e, 3, l - 1)))
					if (l = new RegExp(w(e, 1)), P(l, f)) {
						a = e;
						break a
					}
			}
	...
	function Ma(a, b) {
		...
		for (var d, f = c.length, e = 1; 3 >= e && e <= f; ++e)
			if (d = parseInt(c.substring(0, e), 10), d in L) return b.a(c.substring(e)), d;
		return 0
	}
	...
	function Na(a, b, c, d, f) {
		...
		var g = a.toString();
		if (0 == g.length) e = 20;
		else if (O.test(g)) g = g.replace(O, ""), q(a), a.a(Ea(g)), e = 1;
		else {
			g = new RegExp(e);
			Fa(a);
			e = a.toString();
		...
		if (null != b && (e = x(b, 10), g = "" + e, h = a.toString(), 0 == h.lastIndexOf(g, 0))) {
			var l = new p(h.substring(g.length)),
				h = w(b, 1),
				g = new RegExp(x(h, 2));
			Oa(l, b, null);
			b = l.toString();
	...
	function Pa(a, b, c, d) {
		...
		d && v(e, 5, b);
		a: {
			b = f.toString();g = b.search(ya);
			if (0 <= g && Da(b.substring(0, g)))
				for (var h = b.match(ya), l = h.length, n = 1; n < l; ++n)
